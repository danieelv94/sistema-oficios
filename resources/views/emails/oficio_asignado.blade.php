...
<head>
    ...
    <title>Nuevo Oficio Asignado</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Notificación de Asignación de Tarea</p>
        </div>
        <div class="content">
            <h2 class="greeting">Hola, {{ $usuario->name }}</h2>
            <p class="intro">Se le ha asignado el siguiente oficio para su atención y seguimiento:</p>
            
            <div class="card">
                <span class="card-title">Detalles de Asignación</span>
                
                <div class="info-row">
                    <div class="info-label">Folio Interno:</div>
                    <div class="info-value"><strong>{{ $folio_interno }}</strong></div>
                </div>
                <div class="info-row">
                    <div class="info-label">Oficio Original No:</div>
                    <div class="info-value">{{ $oficio->numero_oficio }}</div>
                </div>
                <div class="info-row">
                ...
                <div class="instruction-box">
                    <div class="instruction-title">Instrucción Recibida:</div>
                    <p class="instruction-text">{{ $instruccion }}</p>
                </div>
            </div>
            
            <div class="btn-container">
                <a href="{{ route('oficios.show', $oficio->id) }}" class="btn">Ver y Atender Oficio</a>
            </div>
        </div>
        <div class="footer">
