<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-t-8 border-guinda-ceaa">
                    ...
                    <form action="{{ route('avisos.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="titulo" id="titulo" value="{{ old('titulo') }}" required
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-guinda-ceaa focus:border-guinda-ceaa placeholder-gray-400"
                            ...
                            <div class="md:col-span-2 bg-gray-50 p-4 rounded-lg border border-dashed border-gray-300">
                                <label for="archivo"
                                    class="block text-sm font-black text-guinda-ceaa uppercase tracking-wider mb-2">
                                ...
                                <input type="file" name="archivo" id="archivo" accept=".pdf, .jpg, .jpeg, .png" class="block w-full text-sm text-gray-500 
                                    ...
                                    file:bg-red-50 file:text-guinda-ceaa 
                        ...
                        <div class="mt-10 flex items-center justify-end gap-4 border-t pt-6">
                            <a href="{{ route('principal') }}"
                             ...
                             <button type="submit"
                                class="inline-flex items-center px-6 py-3 bg-guinda-ceaa border border-transparent rounded-md font-bold text-xs text-white uppercase tracking-widest hover:bg-guinda-ceaa-hover active:bg-opacity-95 focus:outline-none focus:ring-2 focus:ring-guinda-ceaa focus:ring-offset-2 transition ease-in-out duration-150 shadow-lg">
