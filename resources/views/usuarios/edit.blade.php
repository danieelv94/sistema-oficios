                    ...
                    <form action="{{ route('usuarios.update', $user) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <x-input id="prof" class="block mt-1 w-full" type="text" name="prof" :value="old('prof', $user->prof)" />
                            </div>
                            <div>
                            ...
                            <div class="flex items-center md:col-span-2 mt-2">
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="recibir_correos" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 h-5 w-5 mr-2" {{ old('recibir_correos', $user->recibir_correos) ? 'checked' : '' }}>
