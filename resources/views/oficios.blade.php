...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 px-4 sm:px-0">
    <div class="bg-white p-6 rounded-lg shadow-sm border-l-4 border-[#932C43]">
        <p class="text-xs font-bold text-gray-500 uppercase">Total Recibidos</p>
        <p class="text-2xl font-black text-[#932C43]">{{ $correspondenciaGeneral->total() ?? 0 }}</p>
    </div>
    <div class="bg-white p-6 rounded-lg shadow-sm border-l-4 border-blue-600">
        ...
        <p class="text-2xl font-black text-blue-600">{{ $gestionArea->total() ?? 0 }}</p>
    </div>
    <div class="bg-white p-6 rounded-lg shadow-sm border-l-4 border-purple-600">
        ...
        <p class="text-2xl font-black text-purple-600">{{ $misTurnosAsignados->total() ?? 0 }}</p>
    </div>
</div>
                ...
                <div class="p-6">
                    <div class="flex items-center mb-4">
                        <span class="p-2 bg-red-100 rounded-lg mr-3">
                            <svg class="w-6 h-6 text-[#932C43]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                        </span>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white border-collapse">
                            <thead>
                                <tr class="bg-gray-100 text-[#932C43] text-xs font-bold uppercase tracking-wider">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg border-t-4 border-blue-600">
                <div class="p-6">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white border-collapse">
                            <thead>
                                <tr class="bg-blue-50 text-blue-800 text-xs font-bold uppercase tracking-wider">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                ...
                                <tr class="hover:bg-blue-50 transition">
                                    <td class="py-3 px-4 text-sm font-bold text-blue-900">{{ $oficio->numero_oficio }}</td>
                                    ...
                                    <td class="py-3 px-4 text-center">
                                        <a href="{{ route('oficios.show', ['oficio' => $oficio, 'mode' => 'gestion']) }}" 
                                           class="px-3 py-1 bg-blue-600 text-white rounded text-[10px] font-bold hover:bg-blue-800 uppercase tracking-tighter shadow-sm">
                                            Asignar Personal
                                        </a>
                                    </td>
                                </tr>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg border-t-4 border-purple-600">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg border border-purple-100 shadow-sm hover:shadow-md transition group">
                            <div class="flex justify-between items-start mb-2">
                                <span class="text-xs font-black text-purple-700 uppercase">{{ $oficio->numero_oficio }}</span>
                            ...
                            <div class="bg-white p-2 rounded border border-purple-50 text-[10px] italic text-gray-500 mb-4 h-12 overflow-hidden">
                            ...
                            <a href="{{ route('oficios.show', ['oficio' => $oficio, 'mode' => 'operativo']) }}" 
                               class="block text-center w-full py-2 bg-purple-600 text-white rounded text-[10px] font-bold uppercase tracking-widest group-hover:bg-purple-800 transition shadow-sm">
                                Ver Detalles / PDF
                            </a>
                        </div>
                        @empty
