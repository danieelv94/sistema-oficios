                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                        <div class="flex items-center">
                            ...
                            <div>
                                <h3 class="text-lg font-black text-gray-700 uppercase italic">Control de Correspondencia Interna</h3>
                                <p class="text-xs text-gray-400 font-bold uppercase mt-0.5">Oficios emitidos y recibidos entre las Direcciones del Organismo</p>
                            </div>
                        </div>
                                        ...
                                        <td class="py-3.5 px-4 text-gray-600 max-w-xs">
                                            <div class="flex flex-wrap gap-1">
                                                @foreach($oficio->areas as $destArea)
                                                    <span class="px-2 py-0.5 bg-gray-100 border border-gray-200 text-gray-700 text-[9px] font-semibold rounded uppercase">
                                                        {{ $destArea->name }}
                                                    </span>
                                                @endforeach
                                            </div>
