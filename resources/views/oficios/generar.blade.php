...
<body class="bg-gray-100 font-sans p-8">
    ...
    <div class="max-w-4xl mx-auto mb-4 text-right no-print">
        <a href="{{ route('oficios.show', $oficio) }}" class="px-4 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600">&larr; Volver a Detalles</a>
        <button onclick="window.print()" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Imprimir Oficio</button>
    </div>
        ...
        <section class="mb-8">
            ...
            @forelse($oficio->areas as $area)
                <div class="mb-4 pl-4 border-l-2">
                    ...
                    <p><strong>PARA ATENCIÓN DE:</strong> {{ \App\Models\User::find($area->pivot->user_id)->name ?? 'Responsable del Área' }}</p>
                </div>
            @empty
