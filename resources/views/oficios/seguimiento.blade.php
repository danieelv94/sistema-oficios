                        ...
                        <div>
                            <div class="flex items-center gap-3">
                                ...
                                <a href="{{ route('oficios.reporteDiario') }}" 
                                    class="inline-flex items-center gap-1 bg-[#932C43] hover:bg-[#722134] text-white text-[10px] font-black uppercase px-3 py-1 rounded-full shadow-sm hover:shadow transition">
