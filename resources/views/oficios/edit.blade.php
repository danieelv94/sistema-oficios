<x-app-layout>
    ...
    <div class="py-12 bg-gray-50">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-2xl sm:rounded-lg border-t-8 border-blue-600">
                <div class="p-8">
                    ...
                    <form action="{{ route('oficios.update', $oficio) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div class="space-y-4">
                                <h4
                                    class="text-[10px] font-black text-blue-600 uppercase tracking-widest border-b border-blue-50 mb-2">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="numero_oficio" id="numero_oficio"
                                        ...
                                        class="block mt-1 w-full rounded border-gray-300 text-sm focus:ring-blue-500 focus:border-blue-500"
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <div>
                                        ...
                                        <select name="prioridad" id="prioridad"
                                            class="block mt-1 w-full rounded border-gray-300 text-xs font-bold focus:ring-blue-500"
                                            required>
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <div>
                                        ...
                                        <input type="date" name="fecha_recepcion" id="fecha_recepcion"
                                            ...
                                            class="block mt-1 w-full rounded border-gray-300 text-sm focus:ring-blue-500"
                                            required>
                                    </div>
                                    <div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="mt-1 flex justify-center px-6 pt-10 pb-10 border-2 border-gray-300 border-dashed rounded-lg bg-gray-50 hover:bg-blue-50 transition-colors cursor-pointer relative group"
                                    onclick="document.getElementById('archivo_pdf').click()">
                                    <div class="space-y-2 text-center">
                                        <svg id="pdf-icon"
                                            class="mx-auto h-12 w-12 {{ $oficio->pdf_path ? 'text-green-600' : 'text-gray-400' }} group-hover:text-blue-600 transition-colors"
                                        ...
                                        <div class="text-sm text-gray-600">
                                            <span
                                                class="font-black text-blue-600 uppercase text-[10px] tracking-widest">Reemplazar Oficio PDF</span>
                        ...
                        <div class="mt-8 space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="observaciones" id="observaciones" rows="2"
                                    class="block mt-1 w-full rounded border-gray-300 text-sm focus:ring-blue-500 focus:border-blue-500 bg-gray-50 italic">{{ old('observaciones', $oficio->observaciones) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="mt-10 flex justify-end items-center space-x-6 border-t pt-8">
                            <a href="{{ route('oficios.show', $oficio) }}"
                                class="text-xs font-black text-gray-400 uppercase hover:text-blue-600 transition-colors tracking-widest">
                                Cancelar y Regresar
                            </a>
                            <button type="submit"
                                class="px-8 py-3 bg-blue-600 text-white rounded shadow-lg hover:bg-blue-700 transition-all transform active:scale-95 flex items-center">
