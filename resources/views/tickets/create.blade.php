            ...
            <div class="bg-white overflow-hidden shadow-2xl sm:rounded-lg border-t-8 border-guinda-ceaa">
                <div class="p-8">
                    ...
                    <form method="POST" action="{{ route('tickets.store') }}" class="space-y-6">
                        ...
                        {{-- Campo Asunto --}}
                        <div>
                            <x-label for="subject" class="text-guinda-ceaa font-bold uppercase text-xs" :value="__('Asunto o Problema')" />
                            <div class="relative mt-1">
                                ...
                                <x-input id="subject"
                                    class="block mt-1 w-full pl-10 border-gray-300 focus:border-guinda-ceaa focus:ring-guinda-ceaa rounded-md shadow-sm"
                        ...
                        {{-- Campo Descripción --}}
                        <div>
                            <x-label for="description" class="text-guinda-ceaa font-bold uppercase text-xs"
                                :value="__('Descripción Detallada')" />
                            <div class="mt-1">
                                <textarea id="description" name="description" rows="5"
                                    class="block w-full border-gray-300 focus:border-guinda-ceaa focus:ring-guinda-ceaa rounded-md shadow-sm placeholder-gray-300"
                                    required
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg flex items-start space-x-3 border border-gray-100">
                            <div class="p-2 bg-guinda-ceaa rounded text-white">
                        ...
                        <div class="flex items-center justify-end mt-8">
                             <button type="submit"
                                class="w-full sm:w-auto px-8 py-3 bg-guinda-ceaa text-white rounded-md hover:bg-guinda-ceaa-hover font-black uppercase tracking-widest shadow-xl transition-all transform hover:-translate-y-1 active:scale-95">
