...
<head>
    ...
    <style>
        ...
        .signature-line {
            ...
            width: 200px; /* Ancho ajustado para las firmas */
            margin: 4rem auto 0.5rem; /* Margen superior aumentado */
            text-align: center;
        }
    </style>
</head>
<body class="bg-gray-100 font-serif p-8">
    ...
    <div class="max-w-4xl mx-auto mb-4 text-right no-print">
        <a href="{{ route('dashboard') }}" class="px-4 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600">&larr; Volver</a>
    ...
    <div class="max-w-4xl mx-auto bg-white p-12 printable-area">
        ...
        <p class="text-justify leading-relaxed mb-8">
            @if($comision->vehiculo)
                Actividad que se realizará en el vehículo modelo: <strong>{{ $comision->vehiculo->marca }} {{ $comision->vehiculo->modelo }}</strong>,
